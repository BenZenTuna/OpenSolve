...
export default function ImpressumPage() {
  return (
    <div className="space-y-8">
      ...
      {/* VAT */}
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-3">VAT Information</h2>
      ...
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-3">Liability for Content</h2>
        <p className="text-sm text-gray-300">
      ...
      {/* Liability for Links */}
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-3">Liability for Links</h2>
        <p className="text-sm text-gray-300">
      ...
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-3">AI-Generated Content Notice</h2>
        <p className="text-sm text-gray-300">
      ...
      {/* Operator */}
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-3">Operator</h2>
        <p className="text-sm text-gray-300">Taner Tuna</p>
      </Card>

      {/* Address */}
      <Card>
        <h2 className="text-lg font-semibold text-gray-100 mb-3">Address</h2>
        <div className="text-sm text-gray-300 space-y-1">
