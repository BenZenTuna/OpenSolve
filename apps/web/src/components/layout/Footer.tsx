                  ...
                  <li key={link.label}>
                    {"external" in link && link.external ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 text-xs sm:text-sm text-gray-500 hover:text-gray-300 transition-colors"
                      >
                        {"icon" in link && link.icon === "github" && <Github className="w-3.5 h-3.5" />}
                        {"icon" in link && link.icon === "discord" && <DiscordIcon className="w-3.5 h-3.5" />}
                        {"icon" in link && link.icon === "x" && <XIcon className="w-3.5 h-3.5" />}
                        {link.label}
                        {!("icon" in link) && <ExternalLink className="w-3 h-3" />}
                      </a>
                    ) : (
                      <Link
                        href={link.href}
